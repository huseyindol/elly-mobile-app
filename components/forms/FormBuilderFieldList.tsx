  ...
  return (
    <View style={styles.container}>
      <View style={styles.header}>
        <Text style={styles.title}>Alanlar ({fields.length})</Text>
              ...
              <View style={styles.fieldLeft}>
                ...
                <View style={styles.fieldInfo}>
                  ...
                  <View style={styles.fieldMeta}>
                    <Text style={styles.fieldType}>{FIELD_TYPE_LABELS[item.type] ?? item.type}</Text>
                    {item.required && (
...
const styles = StyleSheet.create({
  ...
  addBtn: {
    ...
    backgroundColor: '#4F46E5', paddingHorizontal: 12, paddingVertical: 6, borderRadius: 8,
  },
  ...
  indexBadge: {
    width: 24, height: 24, borderRadius: 12, backgroundColor: '#EEF2FF',
  ...
  requiredBadge: {
    ...
    backgroundColor: '#FEF2F2', paddingHorizontal: 6, paddingVertical: 1, borderRadius: 4,
  },
